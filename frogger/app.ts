document.addEventListener('DOMContentLoaded', () => {
    ...
    const logsLeft: Array<HTMLDivElement> = [];
    const logsRight: Array<HTMLDivElement> = [];
    const carsLeft: Array<HTMLDivElement> = [];
    const carsRight: Array<HTMLDivElement> = [];
    ...
    const moveFrog: ((event: KeyboardEvent) => void) = (event) => {
